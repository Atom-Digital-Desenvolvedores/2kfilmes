<?php
	...
	function hide_buttons_page_custom(){
		...
		<style type="text/css">
			...
			li[class="wp-not-current-submenu menu-top menu-icon-generic toplevel_page_"],
			li[class="wp-not-current-submenu menu-top menu-icon-generic toplevel_page_ menu-top-last"]{
	...
	function remover_menu_posttype() {
		...
		remove_submenu_page( 'themes.php', 'customize.php?return=%2Fwebsite2018%2Fwp-admin%2F' );
